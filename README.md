...
| **Phase 4** | 品質・安定性（転倒防止 watchdog、レイテンシ最適化 VAD チューニング） | ✅ 完了 |
| **Phase 5.1** | エコーキャンセル（音声ゲート方式: TTS再生中のマイク入力を遮断） | ✅ 完了 |
| **Phase 5.2** | シーンキャッシュ + 初回自動スキャン（Vision API 節約・初動高速化） | ✅ 完了 |
...
main
  └─ feat/phase1-navigation   ← Phase 1/2/3 実装
       └─ feat/phase4-quality ← Phase 4 完了（main にマージ済み）
            └─ feat/phase5-enhancement ← Phase 5 開発中
```
...
| `feat/phase4-quality` | Phase 4 品質・安定性改善 | ✅ 完了 |
| `feat/phase5-enhancement` | Phase 5 エコーキャンセル + シーンキャッシュ | 🔄 開発中 |
